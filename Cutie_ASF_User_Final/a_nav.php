...
<body>
            ...
            <div class="header">
                <nav class="navbar navbar-expand-lg">
                    <div class="container">
                        <a href="a_enlist.php" class="navbar-brand">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto" >
                                ...
                                <li class="nav-item dropdown">
                                    <a href="a_enlist.php" class="hvr-overline-from-center nav-link" >ENLIST</a>
                                </li>
                                <!-- #ADOPTED NAV-->
                                <li class="nav-item dropdown">
                                    <a href="a_adopted.php" class="hvr-overline-from-center nav-link">PETS</a>
                                </li>
                                <!-- #REQUEST NAV-->
                                 <li class="nav-item dropdown">
                                    <a href="a_request.php" class="hvr-overline-from-center nav-link">REQUEST</a>
                                </li>
                                <!-- #SEARCH NAV -->
                                <li class="nav-item ">
                    ...
                    <div class="sticky-header" >
                        <div class="auto-container clearfix" >
                            ...
                            <div class="logo pull-left" >
                                <a href="a_enlist.php" class="img-responsive"><img src="images/cutie_small.png" alt=""
                                ...
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse clearfix">
                                        <ul class="navigation clearfix">
                                            <li class="dropdown"><a href="a_enlist.php">Enlist</a></li>
                                            <li class="dropdown"><a href="a_adopted.php">Pets</a></li>
                                            <li class="dropdown"><a href="a_request.php">Request</a></li>
        ...
        <div class="search-popup">
            ...
            <form method="post" action="#">
                <div class="form-group">
                    <input type="search" name="search_field" placeholder="Search Here Using Pet ID or Pet Type" required>
    ...
    <?php
        if(isset($_POST['search_pet'])) {
            ...
            if(str_replace(" ", "", $pet_id) == "") { echo "<script> alert('Invalid input.'); </script>"; }
                ...
                if (db_pet_type_exists($pet_id,$_SESSION['id'])) {
                    $_SESSION['s_type'] = strtolower($pet_id);
                    echo "<script> location.replace('a_enlist.php') </script>";
                }
                elseif(db_pet_petExists($pet_id,$_SESSION['id'])) {
                    $pet_data = db_pet_search($pet_id,$_SESSION['id']);
                    if ($pet_data != 0) {
                        $_SESSION['edit'] = true;
                        ...
                        $_SESSION['p_availability'] = $pet_data[0]['availability'];
                        echo "<script> location.replace('a_enlist_edit.php') </script>";
                    }
                    else {
                        echo "<script> alert('No pet was found 3.'); </script>";
                    }
                }
                else {
                    echo "<script> alert('No pet was found 1.'); </script>";
                }
            }
        }
    ?>
