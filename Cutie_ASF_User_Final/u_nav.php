                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto" >
                                ...
                                <!-- #ADOPTION NAV-->
                                 <li class="nav-item dropdown">
                                    <a href="u_pet.php" class="hvr-overline-from-center nav-link">ADOPT PETS</a>
                                </li>
                                <!-- #ADOPTED NAV-->
                                <li class="nav-item dropdown">
                                    <a href="u_adopted_pets.php" class="hvr-overline-from-center nav-link">MY PETS</a>
                                </li>
                                <!-- #CONTACT NAV-->
                                <li class="nav-item dropdown">
                                ...
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse clearfix">
                                        <ul class="navigation clearfix">
                                            ...
                                            <li class="dropdown"><a href="u_pet.php">Adopt Pets</a></li>
                                            <li class="dropdown"><a href="u_adopted_pets.php">My Pets</a></li>
        ...
        <div class="search-popup">
            ...
            <form method="post" action="#">
                <div class="form-group">
                    <input type="search" name="search_field" id="search_field" placeholder="Search Here Using Pet ID or Pet Type" required>
            ...
            if(str_replace(" ", "", $pet_id) == "") { echo "<script> alert('Invalid input.'); </script>"; }
                ...
                if(db_pet_petExists($pet_id)) {
                    ...
                    if (db_pet_isAvailable($pet_id)) {
                        ...
                        echo "<script> alert('Pet was either requested or adopted already.'); </script>";
                    }
                }
                elseif (db_pet_type_exists($pet_id)) {
                    $_SESSION['s_type'] = strtolower($pet_id);
                    echo "<script> location.replace('u_pet.php') </script>";
                }
                else {
                    echo "<script> alert('No pet was found.'); </script>";
                }
