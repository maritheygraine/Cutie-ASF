        ...
        <div class="pet about second">
            <section class="team">
                <div class="container">
                    ...
                    <?php
                        $pet_data = (isset($_SESSION['s_type'] ) ? db_pet_type_search($_SESSION['s_type']) : db_pet_a_pets($_SESSION['id'])); // GET PET DETAILS FROM DB
                        if ($pet_data != 0) {
                                            ...
                                            <div class="content">
                                                ...
                                                <?php
                                                    if (isset($_POST['pet'.$id])) {
                                                        ...
                                                        $_SESSION['p_availability'] = ucfirst($pet_data[$i]['availability']);
