                ...
                <div class="row clearfix" style="align-items: center; margin-left: 90px;">
                    ...
                    <div class="team-block col-md-4 col-sm-6 col-xs-12" style="margin-top: 16px;">
                        <div class="inner-box" >
                            ...
                            <div class="image" >
                                <a href="#">
                                    <img width="263" height="300" src="images/home_5/pet-10.jfif" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="max-height: 450px;max-width: 450px;"></a>
                            </div>
                            <div class="lower-box">
