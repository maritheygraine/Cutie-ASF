                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-auto" >
                                ...
                                <!-- #ADOPTED NAV-->
                                <li class="nav-item dropdown">
                                    <a href="a_adopted.php" class="hvr-overline-from-center nav-link">ADOPTED</a>
                                </li>
                                <!-- #REQUEST NAV-->
                                 <li class="nav-item dropdown">
                                ...
                                <nav class="main-menu">
                                    ...
                                    <div class="navbar-collapse clearfix">
                                        <ul class="navigation clearfix">
                                            <li class="current dropdown"><a href="a_enlist.php">Enlist</a></li>
                                            <li class="dropdown"><a href="a_adopted.php">Adopted</a></li>
