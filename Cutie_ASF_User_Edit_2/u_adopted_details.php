...
<?php
    ...
    elseif (!isset($_SESSION['u_adopted'])) { echo "<script> location.replace('u_adopted_pets.php') </script>"; }
?>
<head>
    <meta charset="UTF-8">
    <link href="css/style-1.css" rel="stylesheet">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Pet's Information</title>
...
<body>
    <div class="main-wrapper pet tm_profile">
                ...
                <div class="row clearfix" style="align-items: center; margin-left: 90px;">
                    ...
                    <div class="team-block col-md-4 col-sm-6 col-xs-12" style="margin-top: 16px;">
                        <div class="inner-box" >
                            ...
                            <div class="image" >
                                <a href="#">
                                    <img width="263" height="300" src="<?php echo $_SESSION['ap_picture']; ?>" class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="" style="max-height: 450px;max-width: 450px;"></a>
                            </div>
                            <div class="lower-box">
                        ...
                        <div class="memberdetails">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 mdetails">
                                    ...
                                    Form: <?php echo $_SESSION['au_form']; ?>
                                </div>
                            </div>
                        </div>
                        <div class="btn_admin" id="enlist">
                            <a href="u_adopted_pets.php">
        ...
        <section class="new_foot" style="margin-top: 1px;">
            <div class="container">
