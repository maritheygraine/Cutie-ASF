...
<body>
                                        ...
                                        <form method="POST" action="" enctype="multipart/form-data">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-12 col-md-12 col-sm-12">
                                                    <div class="btn_admin">
                                                        <a href="files/adoption_form.docx" download="application form">
                                                             <button type="submit" style="width: 250px; margin-left: 32px;" name="submit_doc">
    ...
    <?php
        if (isset($_POST['submit_doc'])) {
            $file = upload_pet_adoptionForm();
            if ($file != "") {
                if (db_pet_request($_SESSION['p_id'], $_SESSION['id'], $file)) { 
                    echo "<script> alert('Uploading of document was successful. Please wait for our response.'); </script>";
                    echo "<script> location.replace('u_adopted_pets.php') </script>";
                }
                else {
