    ...
    <div class="main-wrapper pet tm_profile">
        ...
        <section class="featured">
            ...
            <div class="auto-container">
                <div class="clearfix">
                    <div class="pull-left">
                        <h2 style="color: white;">Adoption Pets</h2>
                    </div>
                </div>
            </div>
            </section>
                            ...
                            <a href="a_adopted_details.php" class="item-click">
                                <article>
                                    <div class="brows-job-list">
                                        <div class="row">
                                            <div class="col-lg-1 col-md-6 small-padding">
                                                <div class="brows-job-company-img"><img src="images/home_5/pet-2.png"
                                                        class="img-responsive" alt="" style="margin-left: 10px;"></div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="brows-job-position">
                            ...
                            <a href="a_adopted_details.php" class="item-click">
                                <article>
                                    <div class="brows-job-list">
                                        <div class="row">
                                            <div class="col-lg-1 col-md-6 small-padding">
                                                <div class="brows-job-company-img"><img src="images/home_5/pet-3.png"
                                                        class="img-responsive" alt="" style="margin-left: 10px;"></div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="brows-job-position">
