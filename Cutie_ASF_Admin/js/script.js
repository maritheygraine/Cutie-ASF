...
$(document).ready(function () {
    ...
    $('.pet .faq [data-toggle="collapse"]').on('click', function (e) {
    ...
    // if ($("button.btn[type='submit']").length) {
    //     $("button.btn[type='submit']").parent().css({ "display": "inline-block" });
    //     $("button.btn[type='submit']").css({ "width": "auto !important", "padding": "20px 35px !important" });
    // }
    // if ($(".new_foot button.btn[type='submit']").length) {
    //     $("button.btn[type='submit']").parent().css({ "display": "block" });
    // }
