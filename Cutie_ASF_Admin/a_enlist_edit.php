                ...
                <div class="container">
                    ...
                    <div class="row mt-4">
                            ...
                            <div class="faq wow fadeInRight">
                                <form method="POST" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-10">
                                            <div class="form-group">
                                                <input type="number" name="gender" id="gender" placeholder="Gender"
                                        ...
                                        <div class="col-lg-3 col-md-3 col-sm-10">
                                            <div class="form-group">
                                                <textarea name="behavior" id="behavior" class="form-control"
                                                    placeholder="Behavior" disabled></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-3 col-sm-10">
                                            <div class="form-group">
                                                <textarea name="rfa" id="rfa" class="form-control"
                                                    placeholder="Reason for Adoption" disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 col-sm-12">
                                    <div class="image">
                                        <img src="images/home_5/pet-profile.png" alt="image of pet" title="pet" class="img-fluid customer">
                                    </div>
